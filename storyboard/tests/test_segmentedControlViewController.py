...
class SegmentedControlViewControllerTest(UITableViewController):
...
if __name__ == '__main__':
  ...
  main_vc = SegmentedControlViewControllerTest.alloc().initWithStyle_(
    table_style)
  _title = NSStringFromClass(SegmentedControlViewControllerTest)
