...
class MenuButtonViewControllerTest(UITableViewController):
...
if __name__ == '__main__':
  ...
  main_vc = MenuButtonViewControllerTest.alloc().initWithStyle_(table_style)
  _title = NSStringFromClass(MenuButtonViewControllerTest)
