...
class SliderViewControllerTest(UITableViewController):
...
if __name__ == '__main__':
  ...
  main_vc = SliderViewControllerTest.alloc().initWithStyle_(table_style)
  _title = NSStringFromClass(SliderViewControllerTest)
