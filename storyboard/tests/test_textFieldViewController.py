...
class TextFieldViewControllerTest(UITableViewController):
...
if __name__ == '__main__':
  ...
  main_vc = TextFieldViewControllerTest.alloc().initWithStyle_(table_style)
  _title = NSStringFromClass(TextFieldViewControllerTest)
