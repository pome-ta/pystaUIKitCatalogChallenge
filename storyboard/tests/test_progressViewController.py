...
class ProgressViewControllerTest(UITableViewController):
...
if __name__ == '__main__':
  ...
  main_vc = ProgressViewControllerTest.alloc().initWithStyle_(table_style)
  _title = NSStringFromClass(ProgressViewControllerTest)
