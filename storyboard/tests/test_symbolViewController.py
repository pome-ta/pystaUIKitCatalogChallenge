...
class SymbolViewControllerTest(UITableViewController):
...
if __name__ == '__main__':
  ...
  main_vc = SymbolViewControllerTest.alloc().initWithStyle_(table_style)
  _title = NSStringFromClass(SymbolViewControllerTest)
