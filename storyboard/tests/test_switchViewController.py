...
class SwitchViewControllerTest(UITableViewController):
...
if __name__ == '__main__':
  ...
  main_vc = SwitchViewControllerTest.alloc().initWithStyle_(table_style)
  _title = NSStringFromClass(SwitchViewControllerTest)
